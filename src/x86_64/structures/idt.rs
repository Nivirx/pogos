...
use crate::x86_64::{PrivilegeLevel, VirtualAddress, instructions, structures};
...
impl Idt {
    ...
    /// Resets IDT to the default (at boot time) state  
    ...
    /// Loads the IDT in the CPU using the `lidt` command.unresolved import `x86_64`

    pub fn load(&'static self) {
        use instructions::tables::lidt;
        use structures::DescriptorTablePointer;
